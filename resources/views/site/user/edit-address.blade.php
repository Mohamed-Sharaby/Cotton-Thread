            ...
            <div class="container">
                <form class="add-addresses-form" action="{{route('website.users.addresses.update',$address->id)}}" method="post">
                        ...
                        <div class="col-12 col-lg-4">
                            <select name="city_id" id="city_id"
                                ...
                                @foreach(\App\Models\City::all() as $city)
                                    <option
                                        value="{{$city->id}}" {{$address->district->region->city_id == $city->id ? 'selected' : ''}}>{{$city->name}}</option>
                                @endforeach
                            </select>
                            @error('city_id')
                            <div class="invalid-feedback">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-12 col-lg-4">
                            <input type="text" name="street" placeholder="الشارع" value="{{$address->street}}"
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-12 col-lg-4">
                            <input type="text" name="house_num" placeholder="رقم المنزل" value="{{$address->house_num}}"
                        ...
                        <div class="col-12 col-lg-4">
                            <input type="text" name="address" placeholder="تفاصيل العنوان" value="{{$address->address}}"
