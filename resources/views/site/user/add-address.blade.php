            ...
            <form class="add-addresses-form" action="{{route('website.users.addresses.store')}}" method="post">
                ...
                <div class="col-lg-6 col-xs-12">
                    <div class="form-group row">
                        ...
                        <div class="col-lg-10 col-xs-8">
                            <input type="text" name="phone" class="form-control {{$errors->has('phone') ? 'is-invalid' : ''}}" placeholder="الجوال">
                            @error('phone')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                ...
                <div class="col-lg-6 col-xs-12">
                    <div class="form-group row">
                        ...
                        <div class="col-lg-10 col-xs-8">
                            <input type="text" name="street" placeholder="الشارع" class="form-control {{$errors->has('street') ? ' is-invalid' : null}}">
                            @error('street')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                ...
                <div class="col-lg-6 col-xs-12">
                    <div class="form-group row">
                        ...
                        <div class="col-lg-10 col-xs-8">
                            <input type="text" name="house_num" placeholder="رقم المنزل" class="form-control {{$errors->has('house_num') ? ' is-invalid' : null}}">
                            @error('house_num')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                ...
                <div class="col-lg-6 col-xs-12">
                    <div class="form-group row">
                        ...
                        <div class="col-lg-10 col-xs-8">
                            <input type="text" name="address" placeholder="تفاصيل العنوان" class="form-control {{$errors->has('address') ? ' is-invalid' : null}}">
                            @error('address')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
