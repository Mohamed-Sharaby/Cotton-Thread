    ...
    <div class="content">
        ...
        <div class="panel panel-flat">
            <div class="panel-heading">
                <h3 class="panel-title">تعديل العضو
            ...
            <div class="panel-body">
                ...
                <form action="{{route('admin.users.update',$user->id)}}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group row">
                        ...
                        <label for="email" class="col-form-label col-12 col-lg-2 text-lg-right"> البريد
                            الالكترونى</label>
                        <div class="col-12 col-lg-4">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-12 col-lg-4">
                            <input type="text" name="phone" value="{{$user->phone}}" class="form-control {{$errors->has('phone') ? 'is-invalid' : ''}}">
                            @error('phone')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                    ...
                    <div class="form-group row">
                        <label for="image" class="col-form-label col-12 col-lg-2"> الصورة </label>
                        <div class="col-12 col-lg-4">
