        ...
        <div class="container">
            <div class="row">
                <form class="static-page-form" >
                    <a href="#">
                        <img :src="'website/img/logo-wide.png'|baseUrl">
                    </a>
                    <h2>تسجيل دخول </h2>
                    ...
                    <a class="forget-pass" href="#">نسيت كلمة المرور ؟</a>
                    <button type="submit" class="btn-hvr">تسجيل دخول</button>
                    <a href="#" class="btn-hvr bg-w">انشاء حساب</a>
...
<script>
    // import('../../../../../public/website/css/k-style.css');
    export default {
        name: "SignIn"
    }
</script>
