...
var JqueryUiForms = function() {
    ...
    var _componentUiDatepicker = function() {
        ...
        $('.datepicker-icon').datepicker({
            showOn: 'button',
            buttonImage: '../../../../global_assets/sliders/ui/datepicker_trigger.png',
    ...
    var _componentUiSelectmenu = function() {
        ...
        // Initialize
        $('#select-sliders').imageselectmenu({width: '100%'}).imageselectmenu('menuWidget').addClass('ui-selectmenu-images');
    };
